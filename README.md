...
Last updated: 2026-09-23. Links and project descriptions change; please [report a stale entry](https://github.com/AbdelStark/awesome-typesafe-jev/issues/new?template=report-stale.yml).
...
- [Jev Clean](https://github.com/Kunyanli230/jev-clean) — Experimental CSV cleaning tool that computes repair candidates locally and uses Jev Choice, Noul, and Score judgments to gate changes, with audit and rollback records; it sends bounded candidate details and data samples to TypeSafe, and currently limits inputs to 10,000 rows and 30 columns.
...
- [Second Thought](https://github.com/KNambiarDJsc/second-thought) — Python SDK, CLI, and optional local dashboard that captures typed decisions from Laya, Jev, or a custom classifier, measures calibration, and routes uncertain cases to human review; its dataset export excludes Jev decisions in code, and its reported Laya result comes from a 24-ticket example run.
...
- [Paper Radar](https://github.com/Eliot5566/JEV-Paper-Radar) — GitHub Action that sends paper titles, abstracts, and categories from arXiv, bioRxiv, or RSS to Jev for interest and contribution-type judgments, then applies code-owned thresholds to publish a page and RSS feed; a committed 50-paper run reports 5 seconds and $0.001957 with jev-1.13.0, while calibration requires the reader's own labels and the judgments do not inspect full papers.
