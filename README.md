...
[![All Contributors](https://img.shields.io/badge/all_contributors-65-9de3bc.svg?style=flat-square)](#contributors)
...
- [jevgrep (allebee)](https://github.com/allebee/jevgrep) — Streaming grep-by-meaning CLI that asks Jev one Noul per line of a log or other text stream, including `tail -f` output, and prints lines at or above a threshold; the repository includes a hand-labelled benchmark against Claude, and every judged line is sent to OpenRouter or TypeSafe.
