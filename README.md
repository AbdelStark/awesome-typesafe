...
[![All Contributors](https://img.shields.io/badge/all_contributors-60-9de3bc.svg?style=flat-square)](#contributors)
<!-- ALL-CONTRIBUTORS-BADGE:END -->

**The field guide to typed decisions.** Official docs, working integrations, independent experiments, and the builders pushing Jev into new territory.

Jev takes context and returns a probability, a choice, or a score. Your code owns the threshold and the action. That small interface opens up fast classifiers, agents with explicit gates, live games, browser tools, and experiments you can actually inspect.
